...
IGNORE_PATTERNS = [
    ...
    "выполняю работы", "выполняем работы", "выполню работы", "выполним работы",
    "ремонтируем", "ремонтирую", "занимаюсь ремонтом", 
    "строим дома", "строю дома", "работаем качественно", "работаю качественно",
